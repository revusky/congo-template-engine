...
import org.congocc.templates.core.nodes.ArgsList;
import org.congocc.templates.core.nodes.Block;
import org.congocc.templates.core.nodes.Expression;
import org.congocc.templates.core.nodes.IteratorBlock;
import org.congocc.templates.core.nodes.LoopBlock;
import org.congocc.templates.core.nodes.Macro;
import org.congocc.templates.core.nodes.NestedInstruction;
import org.congocc.templates.core.nodes.PositionalArgsList;
import org.congocc.templates.core.nodes.BreakInstruction.BreakException;
import org.congocc.templates.core.nodes.ReturnInstruction.ReturnException;
...
public final class Environment implements Scope {
    ...
    public List<TemplateElement> getElementStack() {
        List<TemplateElement> result = new ArrayList<>(elementStack);
        Collections.reverse(result);// We put this in opposite order, as the trace is usually displayed that way.
        return result;
    }
